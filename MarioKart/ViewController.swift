...
class ViewController: UIViewController,
  ...
  @IBAction func didTapMushroom(_ sender: UITapGestureRecognizer) {
    ...
    // ...
//      let powerUp: MushroomPowerup = MushroomGenerator.maybeGenerateMushroomPowerup()! // The ! forces an unwrap if we don't use ! it will not be unwraped and result in a nil
//      print(powerUp)
